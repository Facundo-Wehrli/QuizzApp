...
const questions = [
  ...
  {
    question: 'Quien es el mejor YouTuber?',
    answers: [
      { text: 'PewDiePie', correct: true },
      { text: 'Mr Beast', correct: true },
      { text: 'El Rubius', correct: true },
      { text: 'Jordi Wild', correct: true }
    ]
  },
  {
    ...
    answers: [
      ...
      { text: 'Obvio que sí ', correct: true },
      { text: 'mmm nop :/', correct: false },
      { text: 'no tengo idea', correct: false }
    ]
  },
  {
  ...
  {
    question: 'Quien va a ganar el mundial?',
    answers: [
